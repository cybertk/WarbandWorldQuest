...
L["settings_pins_tooltip_progress_shown_tooltip"] =
	"Показывать прогресс заданий и награды для всех отслеживаемых персонажей в подсказке на карте"
...
L["settings_log_default_tab_tooltip"] =
	"Установить %s как вкладку по умолчанию, она открывается автоматически при первом открытии мировой карты после входа в игру"
L["settings_log_scanning_icon_shown_text"] = "Иконка ожидания сканирования"
L["settings_log_scanning_icon_shown_tooltip"] =
	"Отображать иконку %s в заголовке задания, если прогресс задания не был отсканирован для всех отслеживаемых персонажей"
