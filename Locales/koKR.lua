...
L["settings_pins_progress_label_shown_tooltip"] = "필터링된 보상을 제공하는 퀘스트 핀에 진행 상황 텍스트를 표시합니다|n|n텍스트 형식은 |cnWHITE_FONT_COLOR:퀘스트 일지|r 설정에서 조정할 수 있습니다."
...
L["settings_log_all_quests_shown_tooltip"] = "모든 탐색 지도에서 퀘스트를 표시합니다|n|n비활성화하면 현재 지도에 있는 퀘스트만 표시됩니다"
...
L["settings_log_scanning_icon_shown_tooltip"] = "추적 중인 모든 캐릭터에서 퀘스트 진행 상황이 스캔되지 않은 경우 퀘스트 제목에 %s 아이콘을 표시합니다"
L["settings_log_progress_shown_text"] = "전투부대 진행 상황"
L["settings_log_progress_shown_tooltip"] = "캐릭터 간 퀘스트 완료 상태를 나타내는 진행 상황 레이블을 표시합니다|n|n|cnWHITE_FONT_COLOR:빨간색 텍스트|r|n현재 캐릭터에게 필터링된 보상을 제공하지 않는 퀘스트입니다|n|n|cnWHITE_FONT_COLOR:초록색 텍스트|r|n현재 캐릭터가 완료한 퀘스트입니다."
L["settings_log_progress_shown_option_1_text"] = "보상을 획득한 캐릭터"
L["settings_log_progress_shown_option_1_tooltip"] = "진행 상황을 |cnWHITE_FONT_COLOR:X/Y|r로 표시합니다|n|n|cnWHITE_FONT_COLOR:X|r|n퀘스트를 완료하고 필터링된 보상을 획득한 캐릭터 수|n|n|cnWHITE_FONT_COLOR:Y|r|n해당 퀘스트에서 필터링된 보상을 획득할 자격이 있는 캐릭터 수"
...
L["settings_log_warband_rewards_shown_tooltip"] = "퀘스트 일지에 모든 캐릭터의 누적 보상을 총합 또는 미수령 상태로 표시합니다.|n비활성화하면 현재 접속 중인 캐릭터의 보상을 표시합니다."
L["settings_maps_title"] = "탐색 지도"
L["settings_filters_title"] = "보상별 퀘스트 필터"
L["settings_section_text"] = "%s 섹션"
L["settings_section_completed_tooltip"] = "완료된 퀘스트 섹션 아래에 완료된 퀘스트를 표시합니다|n|n비활성화하면 완료된 퀘스트가 비활성 섹션 아래에 표시됩니다"
