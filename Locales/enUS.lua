...
L["settings_log_all_quests_shown_text"] = "Show All Quests"
L["settings_log_all_quests_shown_tooltip"] = "Display quests from all scanning maps|n|nIf disabled, only quests on current map are shown"
